...
<body>
	...
	<form method="post">
			...
			<div class="col-4">
				<div class="list-group" id="list-tab" role="tablist">
					<a class="list-group-item list-group-item-action active"
						...
						role="tab" aria-controls="home">Event Date:<%=eventService.proposedDate(Integer.parseInt(iid))%></a>
					<a class="list-group-item list-group-item-action"
						id="list-profile-list" data-toggle="list" href="#list-profile"
						role="tab" aria-controls="profile">Event Time:<%=eventService.proposedTime(Integer.parseInt(iid))%></a>
					<a class="list-group-item list-group-item-action"
						id="list-messages-list" data-toggle="list" href="#list-messages"
						role="tab" aria-controls="messages">Posted Date:<%=eventService.getEventDate(Integer.parseInt(iid))%></a>
					<a class="list-group-item list-group-item-action"
		...
		<input type="submit" value="submit"
			onclick="form.action='rate?id=<%=eventService.getEventId(Integer.parseInt(iid))%>'"	style="align: center;" />
